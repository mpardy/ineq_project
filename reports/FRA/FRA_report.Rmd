...
abstract: "Dieser Report stellt die aktuelle Situation Frankreichs in Bezug auf dessen Einkommensverteilung dar. Dafür wird zuerst betrachtet, wie sich die Einkommensverteilung in Frankreich generell entwickelt hat. Danach wird der Fokus auf die Armutsentwicklung gelegt. Die Einkommensverteilung in Frankreich wird mithilfe von verschiedenen Indikatoren im Zwitraum von 2004 bis 2017 analysiert. Dabei wird der Median, der Mittelwert, der Gini-Index, der Anteil der Top 10% und das S80/S20 Einkommensquintilverhältnis betrachtet. Zur Beurteilung der Entwicklung von Armut und sozialer Ausgrenzung wird die Armutsgefährdungsquote und die Quote der materiellen Deprivation über den selben Betrachtungszeitraum analysiert."
---
...
Fragen der Einkommensverteilung beschäftigen sich häufig mit sozialer Gerechtigkeit. Bereits seit mehreren Wochen häufen sich die Meldungen in den Medien über Proteste von Demonstranten, die durch steigende Treibstoffpreise ausgelöst worden sind, sich jedoch bald in Proteste gegen Ungleichheiten im Land gewandelt haben. Die Gründe für die Demonstrationen der sogenannten "Gelben Westen" sind unter anderem die ökonomische Ungleichheit, die bereits seit Längerem in Frankreich als problematisch gilt, aber auch die Politik von Präsident Macron. [@DeutscheZeitung] 
...
Obwohl Frankreich als relativ egalitär bezeichnet werden kann und im internationalen Vergleich niedrige Werte von Einkommensungleichheits-Indikatoren aufweist, ist es auch in Frankreich zu einem Anstieg von Ungleichheiten gekommen. Neben Frankreich haben auch viele andere Länder, darunter Industrie- und Entwicklungssländer, einen starken Anstieg der Einkommensungleichheit gesehen. [@Pikettyblog]
...
[@Atkinson] Dennoch besteht eine direkte Verbindung zwischen Armut und Ungleichheit: Während Armut sich auf den untersten Anteil der Verteilung beschränkt, bezieht sich der Begriff der Einkommensungleichheit grundsätzlich auf das gesamte Spektrum der Verteilung. 

Die länderübergreifende Analyse von Ländern mit mittleren und hohen Einkommen deutet auf eine starke Korrelation zwischen Armut und Einkommensungleichheit hin. Diese Korrelation ist besonders stark, wenn zur Messung relative Armutsindikatoren, wie etwa die Armutsgefährdungsquote, und bezüglich Einkommensungleichheit Maße wie das P90/P10 Verhältnis oder der Gini-Koeffizient verwendet werden. Bei der langfristigen Betrachtung von Indikatoren bezüglich Armut und Top-Einkommen betreffen, wie etwa der Anteil der Top 10%, zeigt sich jedoch keine konsistente Korrelation. [@Karagiannaki]

Mitte September 2018 verkündete der französische Präsident Emmanuel Macron Frankreichs Strategie gegen Armut. Acht Milliarden Euro sollen zur Verfügung gestellt werden, um Ungleichheiten zu verringern und die Armut innerhalb Frankreichs zu senken. [@povertystrategy2018financial] Besonderer Fokus liegt dabei auf der Förderung von jungen Menschen, deren Ausbildung von Kindheit an unterstützt werden soll.Die Verringerung von Armut und sozialer Ausgrenzung gehört zu den Zielen der Strategie Europa 2020, mittels derer Beschäftigung und Wachstum in der EU gefördert werden soll. Für die fünf Bereiche Armut, Forschung und Entwicklung; Klimawandel und Energie; Beschäftigung und Bildung wurden Zielvorgaben erarbeitet, deren Erreichung laufend überprüft wird. Bezüglich Armut und soziale Ausgrenzung visiert die EU eine Verringerung von zumindest 20 Millionen betroffener Menschen an. [@europkommission]

# Literaturüberblick

##Entwicklung der Einkommensverteilung

Die bisher längste Zeitreihenanalyse der Einkommensverteilung in Frankreich wurde von Garbinti, Goupille-Lebret und Piketty (2018) vorgenommen: Der umfangreiche Datensatz der World Inequality Database ermöglicht eine Langzeitbetrachtung von 1900 bis 2014. Demnach ist der Anteil der reichsten 10 Prozent am Gesamteinkommen seit den 1980er-Jahren deutlich gewachsen. Von 2008 bis 2013 fiel der Anteil der Top 10% zwar etwas, er verblieb 2014 jedoch auf einem höheren Niveau als zu Beginn der 1980er-Jahre. Der Top 5%-Anteil stieg von 1983 bis 2014 noch deutlicher an. Das ist nicht nur auf Zuwächse des Kapitaleinkommens zurückzuführen, sondern ebenso auf einen Anstieg des Arbeitseinkommens. Den größten Zugewinn verzeichnete der Top 1%-Anteil: Er ist von 1983 bis 2007 von rund 8% auf mehr als 12% gklettert, was einem Zuwachs von mehr als 50% entspricht. Als Grund für diese Entwicklung wird etwa die sinkende Einflussnahme von Gewerkschaften genannt. Auch die Zunahme der Vermögenskonzentration dürfte ihren Teil dazu beigetragen haben.[@Piketty2018]

Außerdem analysieren die Autoren die Entwicklung des Gender Pay Gap und kommen für das Jahr 2012 zu folgendem Ergebnis: Die Lohnunterschiede steigen mit zunehmendem Alter an. Mit 25 Jahren verdient ein Mann im Durchschnitt das 1.25-Fache von einer Frau. Im Alter von 65 Jahren, hat sich der Lohnunterschied deutlich vergrößert, da im Durchschnitt das Einkommen eines Mannes bei dem 1.64-Fachen einer Frau liegt. Geschlechtspezifische Lohnunterschiede bleiben somit groß, auch wenn diese in den letzten Jahrzehnten signifikant gesunken sind. [@Piketty2018]

Der Bericht der staatlichen französischen Statistikbehörde INSEE, der die Entwicklungen der Einkommens- und Vermögensverteilung zusammenfasst, kommt zum Ergebnis, dass die Einkommensungleichheiten von 2008 bis 2015 auf einem relativ stabilen Level geblieben sind. Der Gini-Koeffizient ist in dem Zeitraum leicht angestiegen, von 0,289 auf 0,292, sowie die 80/20 Ratio die von 4,3 auf 4,4 gestiegen ist. Die Publikation der staatlichen französischen Statistikbehörde basiert jedoch auf nationalen Daten, die nicht auf EU-Ebene harmonisiert sind, wie die EU-SILC Daten. [@INSEE]

Mögliche Erklärungen für den Anstieg der Top-Einkommen bis 2007 liefert zudem ein Bericht des Institutes for Public Policy (2014) zur Entwicklung der Einkommenssteuer in Frankreich über hundert Jahre hinweg. 1986 gab es in Frankreich 14 verschiedene Einkommenssteuertarife, die von 1994 bis 2006 auf 7 Steuersätze reduziert wurden. Seit 2013 gibt es nur mehr 6 Steuersätze. Im Zuge dessen verringerte sich auch der Grenzsteuersatz für Top-Verdiener: Zwischen 1994 und 2006 betrug er noch 56,8 Prozent; im Jahr 2007 wurde er auf 40 Prozent reduziert. [@InstitutePolicy] Auch etwa Piketty, Saez, und Stantcheva (2014) sehen in der Reduktion der Top-Steuersätze , diedie Progressivität des Einkommenssteuersystems minderte, einen bedeutenden Grund für den Anstieg der Höchsteinkommen in Frankreich. [@Piketty2014]

## Rahmenbedingungen

Die Entwicklung der Einkommensverteilung kann auf diverse Faktoren zurückgeführt werden, wie etwa auf gesamtwirtschaftliche, politische, demographische und institutionelle Veränderungen. Im Falle Frankreichs wirkte sich etwa die Wirtschafts- und Finanzkrise deutlich auf die Verteilung der Einkommen aus. Auch der steigende Anteil alleinerziehender Personen an der Gesamtbevölkerung und die Alterung der Bevölkerung dürften sich auf die Einkommensungleichheit ausgewirkt haben *[@Piketty2014]*.

Im Zuge der Wirtschafts- und Finanzkrise geriet Frankreich in eine Rezession. Das reale Bruttoinlandsprodukt sank von + 2,34% in 2007 auf - 2.9% in 2009 und brach damit innerhalb von zwei Jahren um mehr als 5 Prozentpunkte ein [@EurostatGDP]. Daraufhin stieg der Anteil der Staatsausgaben am Bruttoinlandsprodukt im EU-Vergleich relativ stark an, schreiben Antoine Bozio et al (2015), die die Fiskalpolitik Frankreichs, Italiens, Großbritanniens und Spaniens von 2000 bis 2014 miteinander verglichen. Zur Haushaltskonsolidierung wurden folglich die Steuern erhöht. So wurden etwa 2012 die vorhandenen fünf Einkommenssteuerklassen um eine sechste Klasse erweitert. Der Grenzsteuersatz für Jahreseinkommen von mehr als 150.000€ wurde von 40% auf 45% angehoben; zusätzlich wurde ein Spitzensteuersatz von 75% für Jahreseinkommen ab einer Million beschlossen. Letzterer war allerdings bloß 2013 und 2014 in Kraft. [@Bozio2015]

Am Arbeitsmarkt stieg die Beschäftigungsrate während und nach der Weltwirtschaftskrise unter der älteren Bevölkerung weiter an. Unter der jüngeren Bevölkerung hingegen sank die Beschäftigungsrate ab. Die Erhöhung des Pensionsantrittsalters im Jahr 2010 dürfte zu dieser Entwicklung beigetragen haben. Konkret wurde das Pensionsantrittsalter von 60 auf 62 Jahre angehoben. Arbeitsrechtliche Bestimmungen erschwerten es den Arbeitgebern zudem, während der Krise die Löhne zu senken oder Arbeitnehmer zu kündigen. Folglich wurden Arbeitnehmer geschützt, während Arbeitssuchenden der Zugang zum Arbeitsmarkt erschwert wurde [@Bozio]. Da Arbeitssuchende durchschnittlich jünger sind als Arbeitnehmer, vergrößerten diese Faktoren die Schere der zwischen den Erwerbseinkommen von jungen und älteren Beschäftigten des Privatsektors [@Inseeportrait].

Auch in der Entwicklung der Erwerbseinkommen nieder. Laut der Statistikbehörde Insee ist das Erwerbseinkommen in Frankreich von 2007 bis 2012 bloß um 0,2 Prozent gestiegen, verglichen mit *jährlichen* 0,6 Prozent von 2002 bis 2007. 
Während die Ungleichheit von 2002 bis 2007 über die gesamte Einkommensverteilung hinweg zurückgegangen war, trat von 2007 bis 2012 eine gegenteilige Entwicklung ein: In der unteren Hälfte der Einkommensverteilung stieg die Entfernung derjenigen mit dem niedrigsten Einkommen zu denjenigen in der Nähe des Medians signikfikant an. Die Entfernungen innerhalb der oberen 50% gingen hingegen zurück.[@Inseeportrait]

# Methodologie

## Daten
Um die Einkommensungleichheit und die Entwicklung von Armut in Frankreich im Zeitverlauf sichtbar zu machen, werden die Daten der *European Union Statistics on Income and Living Conditions* (EU-SILC) analysiert. Die Daten werden durch standardisierte jährliche Erhebungen innerhalb der EU zum Thema Einkommen und Lebensbedingungen erhoben, wodurch sie EU-weit vergleichbar sind. Dabei werden ausschließlich Personen befragt, die in Privathaushalten leben. Da der Schwerpunkt der Erhebung auf der Einkommens- und Armutssituation liegt, bietet sich die Analyse der Einkommensverteilung und sozialen Eingliederung in Frankreich mittels des EU-SILC Datensatzes an.[@EurostatEUSILC]

Trotz der EU-weiten Harmonisierung der Datenerhebung treten weiterhin länderspezifischen Unterschiede auf. So wird etwa das Sacheinkommen durch die Bereitstellung von Dienstwägen grundsätzlich separat erhoben und folglich getrennt in die Einkommensaggregate eingerechnet. In Frankreich ist dies aus technischen Gründen allerdings nicht möglich, sodass etwaige Sacheinkommen durch Dienstwägen bereits in der Variable des Bruttojahreseinkommen (PY010G) enthalten sind. Dies soll im Sinne der Nachvollziehbarkeit nicht unerwähnt bleiben, hat auf die vorliegende Analyse jedoch keine Auswirkungen. [@EurostatQualityReport]

*auf schleißige Eurostat-Berechnungen eingehen*
...
Die Zeitreihen für das Median- und Mittelwerteinkommen wurden mit dem Verbraucherpreisindex der Eurostat bereinigt. Dadurch wurden alle Einkommen in das Preisniveau von 2015 konvertiert. Die untenstehende Tabelle gibt einen Überblick über das Median- und Mittelwerteinkommen in Frankreich von 2004 bis 2017 für alle drei Einkommensaggregate nach dem Eurostat-Konzept.
...
knitr::kable(table_mm, caption = "Tabelle 1: Median- und Mittelwerteinkommen, Eurostat-Konzept") %>% kable_styling(bootstrap_options = c("striped"))
```
...
knitr::kable(table_s80, digits=3, caption = "Tabelle 3: S80/S20 Quintilverhältnis von 2004-2017, Eurostat-Konzept") %>% kable_styling(bootstrap_options = c("striped"))
```
...
knitr::kable(table_top, digits=3, caption = "Tabelle 4: Anteil der Top 10% von 2004-2017, Eurostat-Konzept") %>% kable_styling(bootstrap_options = c("striped"))
```
...
Die nachfolgende Tabelle zeigt die Quote der schweren materiellen Deprivation (SMD) über die Zeitreihe von 2011-2017.
