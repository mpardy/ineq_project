...
Problematischer gestalten sich Zeitreihenumbrüche in den Datensätzen, Definitionen ändern sich uim Zeitverlauf, im Rahmen der verfügbaren Daten vermieden -- überhaupt erwähnen, weil wir nicht genau wissen, wo es hakt?

staatlichen französischen Statistikbehörde INSEE
...
Di Zeitreihen für das Median- und Mittelwerteinkommen wurden mit dem Verbraucherpreisindex der Eurostat bereinigt. Dadurch wurden alle Einkommen in das Preisniveau von 2015 konvertiert. 
...
Auffallend ist zudem, dass das Medianeinkommen von 2009 - 2012 fiel, während in den verbleibenden Perioden stets ein Zuwachs zu verzeichnen war. Diese Einbußen werden gemeinhin mit den Folgen der Wirtschafts- und Finanzkrise in Verbindung gebracht (Quelle) 

-> BIP-Entwicklung kurz erwähnen
