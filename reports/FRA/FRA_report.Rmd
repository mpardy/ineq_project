...
abstract:  "Diese Report stellt die aktuelle Situation Frankreichs in Bezug auf dessen Einkommensverteilung dar. Dafür soll zuerst betrachtet werden, wie sich die Einkommensverteilung in Frankreich generell entwickelt hat, und dann der Fokus auf dessen nationale Armutsentwicklung gelegt werden."
keywords: "a, b, c"
...
[@Atkinson] Dennoch besteht eine direkte Verbindung zwischen Armut und Ungleichheit. Während Armut sich nur auf einen gewissen, nämlich den untersten Anteil der Verteilung, beschränkt, beschreibt Ungleichheit das ganze Ausmaß der Verteilung des Einkommens. 
...
Klar ersichtlich ist, dass sowohl das Durchschnitts- als auch das Medianeinkommen in Frankreich von 2007 bis 2017 angestiegen ist. So stieg das mittlere Jahreseinkommen eines äqivalenten Haushaltsmitglieds von 2004 bis 2016 von rund 18.550€ auf 22.020€ an. Das Durchschnittseinkommen stieg noch stärker an und liegt zudem deutlich über dem Medianeinkommen, was bedeutet, dass eine rechtsschiefe Einkommensverteilung vorliegt Auch ist der relative Unterschied zwischen Mittelwert und Median des verfügbaren Einkommens über den untersuchten Zeitraum hinweg gewachsen: 2004 lag der Mittelwert noch 12,6 % über dem Median, 2017 waren es 16,1 %.

Auffallend ist zudem, dass das Medianeinkommen von 2009 bis 2012 fiel, während in den verbleibenden untersuchten Perioden stets ein (zumindest kleiner) Zuwachs zu verzeichnen war. Diese Einbußen können mit der Wirtschafts- und Finanzkrise 2008 in Bezug gesetzt werden, im Schatten derer Frankreichs Volkswirtschaft in die Rezession geriet: Innerhalb von zwei Jahren brach das reale BIP-Wachstum um mehr als 5 Prozentpunkte ein, konkret plus 2,34% in 2007 auf minus 2.9% in 2009. Es liegt nahe, dass sich diese Entwicklung auch auf die Einkommen privater Haushalte negativ auswirkte. [@EurostatGDP]

![Median und Mittelwert des verfügbaren Äquivalenzeinkommens, 2004-2017](img/meanplot.png){width=90%}

#### Gini-Koeffizient

Der Gini-Index misst, wie weit die Einkommensverteilung eines Landes von einer perfekt gleichen Verteilung abweicht. Er kann grundsätzlich Werte zwischen 0 und 1 annehmen, wobei 0 eine vollkommen gleiche Verteilung wiedergibt; 1 eine vollkommen ungleiche Verteilung. Nicht zuletzt aufgrund seiner internationalen Verfügbarkeit und einfachen Interpretation ist der Gini-Index der am häufigsten angewendedete Indikator zur Messung von Ungleichheit in Einkommensverteilungen. Nachteil des Gini-Index ist, dass er auf Veränderungen in der Mitte der Verteilung deutlich stärker reagiert als auf Veränderungen an den Rändern der Verteilung [@Gastwirth2017]. Aus diesem Grund wird er in dieser Arbeit bloß komplementär zu weiteren Ungleichheitsinidikatoren herangezogen.

Im nachfolgenden Graphen ist die Entwicklung der Gini-Indizes der drei Einkommensaggregate von 2007 bis 2017 abgebildet. Der Gini-Index des Faktoreinkommens vor Steuern ist von 2008 bis 2017 leicht angestiegen und liegt deutlich über den Gini-Indizes der anderen beiden Einkommensaggreate, was sich durch die Umverteilungswirkung staatlicher Institutionen erklären lässt. Für alle Einkommenskonzepte befindet sich der Index im Jahr 2007, also in Vorkrisenzeiten, auf dem niedrigsten Niveau des gesamten Betrachtungszeitraumes. Ein deutlicher Peak ist im Jahr 2011 zu erkennen, im gleichen Jahr also, in dem das Medianeinkommen deutlich sank. Dieser Peak fällt für das verfügbare Einkommen allerdings deutlich schwächer aus als für das Nationaleinkommen vor Steuern. (xxx schauen, was für Staatsausgaben und Reformen es gab)
...
Außerdem kann die Armutsgefährdungsquote nach unterschiedlichen Altersschichten aufgeschlüsselt werden. Die untenstehende Tabelle zeigt die Armutsgefährdungsquote der drei unterschiedlichen Altersgruppen: unter 18, zwischen 18-64 und älter als 65 Jahre und für die Jahre 2007, 2010, 2012, 2015 und 2017.
...
Dabei lässt sich erkennen, dass die älteste Altersgruppe, nämlich jene über 65, den niedrigsten Anteil über alle drei Jahre hinweg anzeigt, die von Armut bedroht ist. Die mittlere Altersgruppe hingegen ist in allen Jahren, bis auf in 2017, die am meisten armutsgefährdete Schicht. Der Anteil der armutsgefährdeten unter 18-Jährigen nimmt über den Beobachtungszeitraum kontinuierlich zu und stellt im letzten Jahr die Gruppe dar, die am meisten von Armut bedroht ist.

#### Erhebliche materielle Deprivation

Die Quote der erheblichen materiellen Deprivation ist ein absolutes Maß zur Messung der Armut und beschreibt jenen Anteil der Personen, die aufgrund von mangelnden Resourcen mit materiellen Entbehrungen leben müssen. Dabei wird bewusst unterschieden, ob sich eine Person gewisse Einheiten nicht leisten kann oder will. Um eine verlässlichere Messung der materiellen Deprivation zu ermöglichen, wird ein Index aufgestellt, der insgesamt aus 9 Elementen besteht. Schwere materielle Entbehrung liegt dann vor, wenn sich eine Person vier von diesen neun ausgewählten Elemente nicht leisten kann. Diese umfassen unter anderem ob sich eine Person eine Waschmaschine leisten kann, mehrfach in Zahlungsrückstand (Miete, Strom, Kreditkarte) geraten ist und die Fähigkeit, die Wohnung ausreichend warm halten zu können. Somit werden damit Dimensionen berücksichtigt die für das Leben notwendig sind und einen gewissen Mindeststandard ermöglichen. [@Eurostatindicator]

Die untenstehende Tabelle zeigt die Quote der schweren materiellen Deprivation (SMD) für die Jahre 2007, 2010, 2012, 2015 und 2017.

|Jahr         | 2007  | 2010   | 2012  | 2015   | 2017   |
| ---         | ----- | ------ | ----- | ------ | -----  |
| SMD         | 5,6   | 5,5    | 3,6   | 3,5    | 2,8    |

Diese 9 Elemente werden auf Haushaltsebene abgefragt und anschließend den einzelnen Personen des Haushalts zugeordnet. Im Jahr 2007 waren 5,6% der Bevölkerung in Frankreich von erheblicher materieller Deprivation betroffen. Seit diesem Zeitpunkt lässt sich über den untersuchten Beobachtungszeitraum aufgrund des mithilfe von EU-SILC Daten errechneten Indexes ein kontinuierliches Absinken der Quote der materiellen Deprivation feststellen. Während der Unterschied zwischen 2007 und 2010 eher gering ist, sinkt die Quote der schweren materiellen Deprivation besonderen bis 2012 relativ stark ab und erreicht 2,8% im Jahr 2017. 

Dass der oben berechnete Indikator über den genannten Zeitraum absinkt ist realistisch und stimmt mit anderen Vergleichswerten zur erheblichen materiellen Deprivation überein. Der große Sprung bis 2012 wirkt jedoch nicht plausibel - es liegt nahe, dass dieser aus dem Zeitreihenbruch einer der neun Variable stammt, nämlich jener die den Zahlungsrückstand betrifft. Die Variable und die Definition wurde 2011 geändert: Vor der Änderung wurde nur berücksichtigt, wenn jemals ein Zahlungsrückstand betreffend Miete, Gas, Strom und Kreditkarte entstanden ist. Ab 2011 wurde unterteilt, wie oft ein Rückstand entstanden ist und nur als materielle Deprivation gezählt, wenn dieser zwei Mal oder öfter zustande gekommen ist. Dies erklärt, warum die Quote der materiellen Deprivation abrupt erheblich absinkt.

Beide Armutsindikatoren, die Quote der materiellen Deprivation sowie die Armutsgefährdungsquote, schaffen es jedoch nur ein beschränktes Ausmaß der verschiedenen Armutslagen darzustellen. Um die Vielschichtigkeit von Armut besser darstellen zu können, würde es sich für eine umfangreiche Analyse noch empfehlen weitere Indikatoren zu betrachten. 

# Zusammenfassung

Die Einkommensverteilung in Frankreich wird mithilfe verschiedenen Indikatoren über die Zeitreihe von 2004 bis 2017 analysiert. Dabei wird der Median, der Mittelwert, der Gini-Index, der Anteil der Top 10% und das S80/S20 Einkommensquintilverhältnis untersucht. Seit 2007 lässt sich ein durchgehender Anstieg bezüglich des mittleren aber auch des Durchschnittseinkommens beobachten. Das Durchschnittseinkommen ist über den Beobachtungszeitraum stärker angestiegen und liegt deutlich über dem Medianeinkommen, welches für eine rechtsschiefe Verteilung spricht. Der Mittelwert war 2004 noch um 12,6% höher als der Medien, im Jahr 2017 betrug der Unterschied bereits 16,1%. Die Betrachtung des Gini-Koeffizientens für alle drei Einkommenskonzepte zeigt den niedrigsten Wert im Jahr 2007. Der Gini-Index des Faktoreinkommens vor Steuern zeigt einen leichten Anstieg von 2008 bis 2017 und liegt klar erkennbar über den Gini-Indizes der anderen beiden Einkommensaggregaten, was für Umverteilungseffekte durch staatliche Insitutionen und Steuersätzen spricht. 2011 wird nicht nur höchste Wert des Gini-Koeffizienten erreicht, sondern auch ein deutlicher Rückgang des Medianeinkommens verzeichnet, welches sich durch die Folgen der Wirtschafts- und Finanzkrise erklären lässt.
Für den Anteil den die Top 10% am Gesamteinkommen verdienen, lässt sich über die gesamte Zeitreihe (2004 bis 2017) ein deutlicher Anstieg beobachten, unabhängig davon, welches der drei Einkommensaggregate verwendet wird. Naheliegend für den Anstieg sind einerseits Schwächung die Senkung des Spitzensteuersatzes, der Anstieg der Vermögenskonzentration aber auch weitere ökonomische und institutionelle Faktoren, wie unter anderem die sinkenden Einflussnahme von Gewerkschaften. Zusammenfassend lässt sich aufgrund aller vier Verteilungsindikatoren ein Anstieg der Einkommensungleichheit in Frankreich konstatieren.

Zur Beurteilung der Entwicklung von Armut und sozialen Ausgrenzung innerhalb Frankreichs wurde die Armutsgefährdungsquote und die Quote der materiellen Deprivation über den Betrachtungszeitraum von 2007-2017 untersucht. Im Jahr 2017 waren 12,3% der Bevölkerung in Frankreich von Armut bedroht, gemessen an der Armutsgefährdungsquote. Während der Wirtschafts- und Finanzkrise und der nachfolgenden Rezession zeigt sich der erheblichste Anstieg der Armutsgefährdungsquote und hatte zur Folge, dass 13,6% der Bevölkerung armutsgefährdet waren. Anschließend sinkt der Indikator wieder und erreicht das gleiche Level wie zu Beginn des Betrachtungszeitraumes. Die Aufspaltung nach Geschlecht zeigt, dass die Armutsgefährdungsquote von Frauen kontinuierlich über jener der Männer liegt und damit das Armutsrisiko über die gesamte Zeitreihe für Frauen im Durchschnitt höher ist als für Männer. Außerdem lassen die Berechnungen vermuten, dass von dem bemerkenswerte Anstieg der generellen Armutsgefährdungsquote mehr Frauen als Männer betroffen waren. Armut in Form von erheblicher materieller Entbehrung, zeigt jedoch ein anderes Bild als die Armutsgefährdungsquote: Über den untersuchten Beobachtungszeitraum sinkt die Quote der materiellen Deprivation kontinuierlich ab und erreicht 2017 ein deutliches niederes Level als zum Beginn, im Jahr 2007.
