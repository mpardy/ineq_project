...
Außerdem kann die Armutsgefährdungsquote nach unterschiedlichen Altersschichten aufgeschlüsselt werden. Die untenstehende Tabelle zeigt die Armutsgefährdungsquote der drei unterschiedlichen Altersgruppen: unter 18, zwischen 18-64 und älter als 65 Jahre  
...
Dass der oben berechnete Indikator über den genannten Zeitraum absinkt ist realistisch und stimmt mit anderen Vergleichswerter zur erheblichen materiellen Deprivation überein. Der große Sprung bis 2012 wirkt jedoch nicht plausibel - es liegt nahe, dass dieser aus dem Zeitreihenbrüchen einer der neuen Variable stammt, nämlich jener die den Zahlungsrückstand betrifft. Die Variable und die Definitionen wurde 2011 geändert: Vor der Änderung wurde nur berücksichtigt, wenn jemals ein Zahlungsrückstand betreffend Miete, Gas, Strom und Kreditkarte entstanden ist. Ab 2011 wurde unterteilt, wie oft ein Rückstand entstanden ist und nur als materielle Deprivation gezählt, wenn dieser zwei Mal oder öfter enstanden ist. Dies erklärt, warum die Quote der materiellen Deprivation abrupt erheblich absinkt.
